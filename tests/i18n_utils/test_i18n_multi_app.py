...
def test_i18n_multi_chinese_locale(dash_duo):
    """测试多语言文件中文本地化功能"""
...
def test_i18n_multi_english_locale(dash_duo):
    """测试多语言文件英文本地化功能"""
    app = Dash(__name__, suppress_callback_exceptions=True)
...
def test_i18n_multi_japanese_locale(dash_duo):
    """测试多语言文件日文本地化功能"""
    app = Dash(__name__, suppress_callback_exceptions=True)
